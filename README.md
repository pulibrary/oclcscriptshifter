...
By default, ScriptShifter converts Chinese numerals to pinyin, but the "ConvertNumbers" macro in "PinyinExtras" can be run to convert the pinyin numbers to Arabic numerals, if desired (e.g. "yi bai er shi san" --> "123").
